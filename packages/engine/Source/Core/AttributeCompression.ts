...
class AttributeCompression {
  ...
  /**
   * Encodes a normalized vector into 4 bytes following the 'oct' encoding.
   *
   ...
   * @see AttributeCompression.octDecodeInRange
   */
  static octDecode(x: number, y: number, result: Cartesian3): Cartesian3 {
   ...
   */
  static octDecodeFromCartesian4(
    encoded: Cartesian4,
    result: Cartesian3,
  ): Cartesian3 {
    //>>includeStart('debug', pragmas.debug);
   ...
   * @returns The decoded and normalized vector.
   */
  static octDecodeFloat(value: number, result: Cartesian3): Cartesian3 {
    //>>includeStart('debug', pragmas.debug);
   ...
   */
  static decompressTextureCoordinates(
    compressed: number,
    result: Cartesian2,
  ): Cartesian2 {
    //>>includeStart('debug', pragmas.debug);
