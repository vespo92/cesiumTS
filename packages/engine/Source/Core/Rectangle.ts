...
/**
 * A Rectangle-like interface for duck-typing
 */
...
/**
 * A Cartographic-like interface for duck-typing
 */
...
/**
 * A Cartesian3-like interface for duck-typing
 */
...
/**
 * An Ellipsoid-like interface for duck-typing
 */
interface EllipsoidLike {
  cartesianToCartographic(cartesian: Cartesian3Like, result?: CartographicLike): CartographicLike;
  cartographicToCartesian(cartographic: CartographicLike, result?: Cartesian3Like): Cartesian3Like;
}

// Scratch variables for fromBoundingSphere
...
class Rectangle {
   ...
   * @constant
   */
  static MAX_VALUE: Readonly<Rectangle>;
  ...
  clone(result?: Rectangle): Rectangle {
    return Rectangle.clone(this, result) as Rectangle;
  }
   ...
   */
  equalsEpsilon(other?: RectangleLike, epsilon?: number): boolean {
   ...
   */
  static computeWidth(rectangle: RectangleLike): number {
    //>>includeStart('debug', pragmas.debug);
   ...
   */
  static computeHeight(rectangle: RectangleLike): number {
    //>>includeStart('debug', pragmas.debug);
    Check.typeOf.object("rectangle", rectangle);
    //>>includeEnd('debug');
  ...
  static fromCartographicArray(
    cartographics: CartographicLike[],
    result?: Rectangle
  ): Rectangle {
    //>>includeStart('debug', pragmas.debug);
  ...
  static fromBoundingSphere(
    ...
    if (Cartesian3.equals(center as Cartesian3, Cartesian3.ZERO)) {
    ...
    Cartesian3.add(center as Cartesian3, north, corner);

    // West
    corner = positions[1];
    Cartesian3.add(center as Cartesian3, west, corner);

    // South
    corner = positions[2];
    Cartesian3.add(center as Cartesian3, south, corner);

    // East
    corner = positions[3];
    Cartesian3.add(center as Cartesian3, east, corner);

    positions[4] = center as Cartesian3;
   ...
   * @param {Rectangle} [result] The object onto which to store the result, or undefined if a new instance should be created.
   * @returns {Rectangle | undefined} The modified result parameter or a new Rectangle instance if none was provided. (Returns undefined if rectangle is undefined)
   */
  static clone(
   ...
   */
  static equals(left?: RectangleLike, right?: RectangleLike): boolean {
    return (
      left === right ||
      (defined(left) &&
        defined(right) &&
   ...
   * @private
   */
  static _validate(rectangle: RectangleLike): void {
    //>>includeStart('debug', pragmas.debug);
    Check.typeOf.object("rectangle", rectangle);
   ...
   */
  static southwest(rectangle: RectangleLike, result?: CartographicLike): CartographicLike {
    //>>includeStart('debug', pragmas.debug);
    Check.typeOf.object("rectangle", rectangle);
    //>>includeEnd('debug');
   ...
   * @returns {Cartographic} The modified result parameter or a new Cartographic instance if none was provided.
   */
  static northwest(rectangle: RectangleLike, result?: CartographicLike): CartographicLike {
    //>>includeStart('debug', pragmas.debug);
    Check.typeOf.object("rectangle", rectangle);
    //>>includeEnd('debug');
   ...
   * @returns {Cartographic} The modified result parameter or a new Cartographic instance if none was provided.
   */
  static northeast(rectangle: RectangleLike, result?: CartographicLike): CartographicLike {
    //>>includeStart('debug', pragmas.debug);
    Check.typeOf.object("rectangle", rectangle);
    //>>includeEnd('debug');
   ...
   * @returns {Cartographic} The modified result parameter or a new Cartographic instance if none was provided.
   */
  static southeast(rectangle: RectangleLike, result?: CartographicLike): CartographicLike {
    //>>includeStart('debug', pragmas.debug);
    Check.typeOf.object("rectangle", rectangle);
    //>>includeEnd('debug');
   ...
   * @returns {Cartographic} The modified result parameter or a new Cartographic instance if none was provided.
   */
  static center(rectangle: RectangleLike, result?: CartographicLike): CartographicLike {
    //>>includeStart('debug', pragmas.debug);
    Check.typeOf.object("rectangle", rectangle);
    //>>includeEnd('debug');
   ...
   */
  static contains(rectangle: RectangleLike, cartographic: CartographicLike): boolean {
    //>>includeStart('debug', pragmas.debug);
    Check.typeOf.object("rectangle", rectangle);
    Check.typeOf.object("cartographic", cartographic);
    //>>includeEnd('debug');
  ...
  static subsample(
    ...
    lla.longitude = west;
    lla.latitude = north;
    result![length] = ellipsoid.cartographicToCartesian(lla, result![length]) as Cartesian3;
    length++;
...
// Initialize static constant after class definition
